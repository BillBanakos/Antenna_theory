...
from .modules.ch6_pattern_mult import Chapter6PatternMult
...
from .modules.derivation import DerivationStudio
from .modules.quiz import QuizMode
...
NAV = [
    ...
    ("ΚΕΦ. 6 — Στοιχειοκεραίες", [
        ...
        ("Πολλαπλασιασμός διαγραμμάτων", Chapter6PatternMult),
    ...
    ("ΕΡΓΑΛΕΙΑ", [
        ("Βήμα-προς-βήμα (LaTeX)", DerivationStudio),
        ("Quiz — εξάσκηση", QuizMode),
    ]),
    ("ΠΟΛΛΑΠΛΗΣ ΕΠΙΛΟΓΗΣ", [
